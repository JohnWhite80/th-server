...
@ComponentScan(basePackages = "com.github.th.server.service")
@EnableJpaRepositories(basePackages = { "com.github.th.server.repository" })
...
public class AppConfig {
	...
	private LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean() {
		...
		lef.setPackagesToScan("com.github.th.server.entity");
		return lef;
	}
